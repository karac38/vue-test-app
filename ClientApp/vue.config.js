...
module.exports = {
  configureWebpack: {
    ...
    devServer: {
      // When running in IISExpress, the env variable wont be provided.
      // Hardcode it here based on your launchSettings.json
      proxy: process.env.ASPNET_URL || 'https://localhost:44345',
    },
    // Use source map for debugging in VS and VS Code
    devtool: 'source-map',
    // Breakpoints in VS and VSCode wont work since the source maps conside
    // clien-app the project root, rather than its parent folder
    output: {
